...
from pydaruma.pydaruma import regTempoAlertar_MODEM_DarumaFramework
...
class Ui_ui_MODEM_regTempoAlertar(QtGui.QWidget):
    ...
    def on_Enviar_clicked(self):
        StrTempoAlertar = self.lineEditTempoAlertar.text()
        tratarRetornoModemReg(regTempoAlertar_MODEM_DarumaFramework(StrTempoAlertar), self)
