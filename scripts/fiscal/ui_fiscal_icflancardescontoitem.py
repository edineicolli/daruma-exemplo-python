...
from pydaruma.pydaruma import iCFLancarDescontoItem_ECF_Daruma
...
class Ui_ui_FISCAL_iCFLancarDescontoItem(QtGui.QWidget):
    ...
    def on_pushButtonEnviar_clicked(self):
        ...
        tratarRetornoFiscal(iCFLancarDescontoItem_ECF_Daruma(StrNumeroItem,StrTipoDesc,StrValorDesc), self)
