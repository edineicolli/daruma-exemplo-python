...
# Form implementation generated from reading ui file 'ui_fiscal_rgerarsintegra.ui'
#
# Created: Mon Nov 24 22:26:27 2014
...
from pydaruma.pydaruma import regAlterarValor_Daruma, rGerarSINTEGRA_ECF_Daruma
...
class Ui_ui_FISCAL_rGerarSINTEGRA(QtGui.QWidget):
    ...
    def setupUi(self, ui_FISCAL_rGerarSINTEGRA):
        ui_FISCAL_rGerarSINTEGRA.setObjectName("ui_FISCAL_rGerarSINTEGRA")
        ui_FISCAL_rGerarSINTEGRA.resize(319, 225)
        ui_FISCAL_rGerarSINTEGRA.setMaximumSize(QtCore.QSize(319, 225))
        self.verticalLayout_4 = QtGui.QVBoxLayout(ui_FISCAL_rGerarSINTEGRA)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.groupBox_2 = QtGui.QGroupBox(ui_FISCAL_rGerarSINTEGRA)
        ...
        self.groupBox_3 = QtGui.QGroupBox(ui_FISCAL_rGerarSINTEGRA)
        ...
        self.pushButtonEnviar = QtGui.QPushButton(ui_FISCAL_rGerarSINTEGRA)
        self.pushButtonEnviar.setObjectName("pushButtonEnviar")
        self.horizontalLayout.addWidget(self.pushButtonEnviar)
        spacerItem5 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem5)
        self.pushButtonCancelar = QtGui.QPushButton(ui_FISCAL_rGerarSINTEGRA)
        ...
        self.retranslateUi(ui_FISCAL_rGerarSINTEGRA)
        QtCore.QMetaObject.connectSlotsByName(ui_FISCAL_rGerarSINTEGRA)

    def retranslateUi(self, ui_FISCAL_rGerarSINTEGRA):
        ui_FISCAL_rGerarSINTEGRA.setWindowTitle(QtGui.QApplication.translate("ui_FISCAL_rGerarSINTEGRA", "Método rGerarSINTEGRA_ECF_Daruma", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_2.setTitle(QtGui.QApplication.translate("ui_FISCAL_rGerarSINTEGRA", "Intervalo:", None, QtGui.QApplication.UnicodeUTF8))
        self.radioButtonDATAM.setText(QtGui.QApplication.translate("ui_FISCAL_rGerarSINTEGRA", "DATAM", None, QtGui.QApplication.UnicodeUTF8))
        self.labelInicial.setText(QtGui.QApplication.translate("ui_FISCAL_rGerarSINTEGRA", "Inicial:", None, QtGui.QApplication.UnicodeUTF8))
        self.dateEditInicial.setDisplayFormat(QtGui.QApplication.translate("ui_FISCAL_rGerarSINTEGRA", "ddMMyyyy", None, QtGui.QApplication.UnicodeUTF8))
        self.labelFinal.setText(QtGui.QApplication.translate("ui_FISCAL_rGerarSINTEGRA", "Final:", None, QtGui.QApplication.UnicodeUTF8))
        self.dateEditFinal.setDisplayFormat(QtGui.QApplication.translate("ui_FISCAL_rGerarSINTEGRA", "ddMMyyyy", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_3.setTitle(QtGui.QApplication.translate("ui_FISCAL_rGerarSINTEGRA", "Local de Gravação", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("ui_FISCAL_rGerarSINTEGRA", "Local:", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButtonEnviar.setText(QtGui.QApplication.translate("ui_FISCAL_rGerarSINTEGRA", "Enviar", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButtonCancelar.setText(QtGui.QApplication.translate("ui_FISCAL_rGerarSINTEGRA", "Cancelar", None, QtGui.QApplication.UnicodeUTF8))
